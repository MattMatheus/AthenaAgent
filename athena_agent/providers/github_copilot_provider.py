...
TOKEN_APP_NAME = "athena_agent"
USER_AGENT = "athena_agent/0.1"
...
class GitHubCopilotProvider(OpenAICompatProvider):
    ...
    async def _get_copilot_access_token(self) -> str:
        ...
        if not github_token or not github_token.access:
            raise RuntimeError("GitHub Copilot is not logged in. Run: athena_agent provider login github-copilot")
