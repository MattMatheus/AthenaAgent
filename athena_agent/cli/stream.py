...
from athena_agent import __logo__
...
class ThinkingSpinner:
    """Spinner that shows 'athena_agent is thinking...' with pause support."""

    def __init__(self, console: Console | None = None):
        c = console or _make_console()
        self._spinner = c.status("[dim]athena_agent is thinking...[/dim]", spinner="dots")
        self._active = False
...
class StreamRenderer:
    ...
    async def on_delta(self, delta: str) -> None:
        ...
        if self._live is None:
            ...
            c = _make_console()
            c.print()
            c.print(f"[cyan]{__logo__} athena_agent[/cyan]")
