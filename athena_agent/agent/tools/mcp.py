"""MCP client: connects to MCP servers and wraps their tools as native AthenaAgent tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a native AthenaAgent tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only athena_agent Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only athena_agent Tool."""
