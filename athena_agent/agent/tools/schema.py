"""JSON Schema fragment types: all subclass :class:`~athena_agent.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~athena_agent.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~athena_agent.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~athena_agent.agent.tools.base.Schema`.
...
from athena_agent.agent.tools.base import Schema
