...
def get_config_path() -> Path:
    ...
    return Path.home() / ".athena-agent" / "config.json"
...
def _apply_ssrf_whitelist(config: Config) -> None:
    ...
    from athena_agent.security.network import configure_ssrf_whitelist
...
def _migrate_config(data: dict) -> dict:
    ...
    if "channels" in data and "output" not in data:
        data["output"] = data["channels"]
    ...
    # Drop removed legacy sections when loading old configs.
